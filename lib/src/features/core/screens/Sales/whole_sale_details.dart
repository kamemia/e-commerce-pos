...
class WholeSaleDetails extends StatefulWidget {
  const WholeSaleDetails({Key? key}) : super(key: key);

  @override
  _WholeSaleDetailsState createState() => _WholeSaleDetailsState();
}

class _WholeSaleDetailsState extends State<WholeSaleDetails> {
  @override
